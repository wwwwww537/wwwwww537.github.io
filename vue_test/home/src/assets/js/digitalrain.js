  ...
  $packages["main"] = (function () {
    ...
    main = function () {
      ...
      $global.addEventListener($externalize("load", $String), $externalize((function $b() {
        var _r, _r$1, _tuple, _tuple$1, cover, err, rain1, rain2, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; _r$1 = $f._r$1; _tuple = $f._tuple; _tuple$1 = $f._tuple$1; cover = $f.cover; err = $f.err; rain1 = $f.rain1; rain2 = $f.rain2; $s = $f.$s; $r = $f.$r; } s: while (true) {
          switch ($s) {
            case 0:
              rain1 = [rain1];
              rain2 = [rain2];
			...
			/* } */ case 2:
              ...
              $global.addEventListener($externalize("resize", $String), $externalize((function (rain1, rain2) {
                return function () {
                  rain1[0].layout();
                };
			...
			/* } */ case 5:
              ...
              rain2[0].Clicked = (function (rain1, rain2) {
                return function () {
        ...
        } if ($f === undefined) { $f = { $blk: $b }; } $f._r = _r; $f._r$1 = _r$1; $f._tuple = _tuple; $f._tuple$1 = _tuple$1; $f.cover = cover; $f.err = err; $f.rain1 = rain1; $f.rain2 = rain2; $f.$s = $s; $f.$r = $r; return $f;
      }), funcType));
    };
    itoa = function (i) {
      var i;
    ...
    DigitalRain.ptr.prototype.start = function () {
      var _i, _ref, f, r, raf, s, $deferred;
		/* */ var $err = null; try {
        $deferred = []; $deferred.index = $curGoroutine.deferStack.length; $curGoroutine.deferStack.push($deferred);
        r = this;
        raf = "";
    ...
    DigitalRain.ptr.prototype.layout = function () {
      ...
      r.canvas.addEventListener($externalize("click", $String), $externalize((function $b(ev) {
        var ev, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; ev = $f.ev; $s = $f.$s; $r = $f.$r; } s: while (true) {
          switch ($s) {
            case 0:
        ...
        } if ($f === undefined) { $f = { $blk: $b }; } $f.ev = ev; $f.$s = $s; $f.$r = $r; return $f;
      }), funcType$1));
